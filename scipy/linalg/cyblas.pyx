...
cdef:
    ...
    cdotc_t* cdotc = <cdotc_t*>f2py_ptr(blas.cdotc._cpointer)
    cdotu_t* cdotu = <cdotu_t*>f2py_ptr(blas.cdotu._cpointer)
    ...
    csrot_t* csrot = <csrot_t*>f2py_ptr(blas.cscal._cpointer)
    ...
    sasum_t* sasum = <sasum_t*>f2py_ptr(blas.sasum._cpointer)
    saxpy_t* saxpy = <saxpy_t*>f2py_ptr(blas.saxpy._cpointer)
    scasum_t* scasum = <scasum_t*>f2py_ptr(blas.scasum._cpointer)
    scnrm2_t* scnrm2 = <scnrm2_t*>f2py_ptr(blas.scnrm2._cpointer)
    scopy_t* scopy = <scopy_t*>f2py_ptr(blas.scopy._cpointer)
    sdot_t* sdot = <sdot_t*>f2py_ptr(blas.sdot._cpointer)
    ...
    snrm2_t* snrm2 = <snrm2_t*>f2py_ptr(blas.snrm2._cpointer)
    ...
    zdotc_t* zdotc = <zdotc_t*>f2py_ptr(blas.zdotc._cpointer)
    zdotu_t* zdotu = <zdotu_t*>f2py_ptr(blas.zdotu._cpointer)
